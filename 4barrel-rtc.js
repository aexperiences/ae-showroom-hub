/* mca-rtc.js — Prairie Auto Sales (AEHub) NATIVE video conferencing (own WebRTC, no third party)
   ------------------------------------------------------------------------
...
(function () {
  ...
  var API = (window.AE4BARREL_API||'https://ae-connect-api.vercel.app')+'/api/connect';
  ...
  window.FBMeet = ESPOAPI; window.MCAMeet = ESPOAPI; window.ESPOMeet = ESPOAPI; window.LCPMeet = ESPOAPI;
})();
